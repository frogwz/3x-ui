...
func (t *Tgbot) getInboundUsages() string {
	...
	for _, inbound := range inbounds {
		...
		info.WriteString(t.I18nBot("tgbot.messages.traffic", "Total=="+common.FormatTraffic(service.InboundBilledUsage(inbound)), "Upload=="+common.FormatTraffic(inbound.Up), "Download=="+common.FormatTraffic(inbound.Down)))
...
func (t *Tgbot) searchInbound(chatId int64, remark string) {
	...
	for _, inbound := range inbounds {
		...
		info += t.I18nBot("tgbot.messages.traffic", "Total=="+common.FormatTraffic(service.InboundBilledUsage(inbound)), "Upload=="+common.FormatTraffic(inbound.Up), "Download=="+common.FormatTraffic(inbound.Down))
