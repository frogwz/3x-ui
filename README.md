...
<p align="center">
  <a href="https://github.com/MHSanaei/3x-ui/releases"><img src="https://img.shields.io/github/v/release/frogwz/3x-ui" alt="Release"></a>
  <a href="https://github.com/MHSanaei/3x-ui/actions"><img src="https://img.shields.io/github/actions/workflow/status/frogwz/3x-ui/main.yml.svg" alt="Build"></a>
  <a href="#"><img src="https://img.shields.io/github/go-mod/go-version/frogwz/3x-ui.svg" alt="GO Version"></a>
  <a href="https://github.com/MHSanaei/3x-ui/releases/latest"><img src="https://img.shields.io/github/downloads/frogwz/3x-ui/total.svg" alt="Downloads"></a>
  <a href="https://www.gnu.org/licenses/gpl-3.0.en.html"><img src="https://img.shields.io/badge/license-GPL%20V3-blue.svg?longCache=true" alt="License"></a>
  <a href="https://pkg.go.dev/github.com/frogwz/3x-ui/v3"><img src="https://pkg.go.dev/badge/github.com/frogwz/3x-ui/v3.svg" alt="Go Reference"></a>
  <a href="https://goreportcard.com/report/github.com/frogwz/3x-ui/v3"><img src="https://goreportcard.com/badge/github.com/frogwz/3x-ui/v3" alt="Go Report Card"></a>
</p>
...
```bash
bash <(curl -Ls https://raw.githubusercontent.com/frogwz/3x-ui/main/install.sh)
```

To install a specific version, append its tag (e.g. `v3.4.0`):

```bash
bash <(curl -Ls https://raw.githubusercontent.com/frogwz/3x-ui/main/install.sh) v3.4.0
```

To install the rolling **dev** build (latest per-commit pre-release from `main`, not a stable release), pass `dev-latest`:

```bash
bash <(curl -Ls https://raw.githubusercontent.com/frogwz/3x-ui/main/install.sh) dev-latest
```
...
```bash
docker run -d --cap-add=NET_ADMIN --cap-add=NET_RAW ... ghcr.io/frogwz/3x-ui
```
