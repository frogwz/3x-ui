...
export function statsColor(stats: ClientStats, trafficDiff: number, multiplier: number = 1) {
  return ColorUtils.usageColor((stats.up + stats.down) * multiplier, trafficDiff, stats.total);
}
