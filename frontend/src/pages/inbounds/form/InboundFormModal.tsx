...
export default function InboundFormModal({
  ...
  const basicTab = (
    <>
      ...
      <Form.Item
        name="enableDoubleBilling"
        label={
          <Tooltip title={t('pages.inbounds.enableDoubleBillingDesc')}>
            {t('pages.inbounds.enableDoubleBillingTitle')}
          </Tooltip>
        }
      ...
      {(() => {
        const trafficReset = Form.useWatch('trafficReset', form);
        if (trafficReset !== 'monthly') return null;
        return (
          <Form.Item
            name="trafficResetDay"
            label={
              <Tooltip title={t('pages.inbounds.periodicTrafficResetDayDesc')}>
                {t('pages.inbounds.periodicTrafficResetDayTitle')}
              </Tooltip>
            }
          >
